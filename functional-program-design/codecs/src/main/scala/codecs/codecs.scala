...
trait EncoderInstances {
  ...
  implicit val stringEncoder: Encoder[String] =
    Encoder.fromFunction(x => Json.Str(x)) // TODO Implement the `Encoder[String]` instance

  /** An encoder for `Boolean` values */
  implicit val booleanEncoder: Encoder[Boolean] =
    Encoder.fromFunction(x => Json.Bool(x)) // TODO Define an implicit value of type `Encoder[Boolean]`
...
trait DecoderInstances {
  ...
  implicit val intDecoder: Decoder[Int] =
    Decoder.fromPartialFunction { case Json.Num(x) if x.isValidInt => x.toIntExact } // TODO Define an implicit value of type `Decoder[Int]`

  /** A decoder for `String` values */
  implicit val stringDecoder: Decoder[String] =
    Decoder.fromPartialFunction { case Json.Str(x) => x } // TODO Define an implicit value of type `Decoder[String]`

  /** A decoder for `Boolean` values */
  implicit val booleanDecoder: Decoder[Boolean] =
    Decoder.fromPartialFunction { case Json.Bool(x) => x } // TODO Define an implicit value of type `Decoder[Boolean]`
  ...
  def field[A](name: String)(implicit decoder: Decoder[A]): Decoder[A] = {
    Decoder.fromFunction {
      case Json.Obj(x) => x.get(name).flatMap(decoder.decode)
    }
  }
